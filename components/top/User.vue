<template>
  <div class="relative w-full">
    <div
      class="flex items-center justify-between bg-white shadow cursor-pointer rounded-xl transition-base hover:shadow-md"
      @click="openMenu"
    >
      ...
      <div class="flex items-center justify-center pr-2 justify-self-end">
        <font-awesome-icon
