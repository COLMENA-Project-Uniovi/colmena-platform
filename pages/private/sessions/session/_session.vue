<template>
  <div class="grid grid-cols-2 gap-8 px-10 py-8">
    ...
    <div
      ...
      <h2 class="text-2xl font-bold">Objetivos de la
        sesión</h2>
      <p>
        {{ session.objective }}
      </p>
          ...
          <div class="hidden p-4 pt-0" marker-info>
            <div class="flex flex-col gap-2">
              ...
              <div
                class="flex flex-col rounded-lg shadow-sm">
                <span
                  class="w-full p-2 text-xl font-bold bg-white rounded-lg border-[1px] border-gray-100">Código</span>
                <span class="p-2 pl-3 text-sm">// {{
...
export default {
  ...
  methods: {
    ...
    expandError(id) {
      ...
      const marker_arrow = document.querySelector(`[data-error-id="${id}"] [marker-arrow]`);
