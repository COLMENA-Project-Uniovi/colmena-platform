  ...
  <div class="grid grid-cols-2 gap-8">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="relative flex flex-col items-start gap-2 p-3 bg-white cursor-pointer rounded-xl"
            ...
            <div class="flex items-center justify-start gap-1">
              ...
              >
                <font-awesome-icon
                  ...
                  class="opacity-60"
                />
                <span class=""> {{ marker.timestamp.split('T')[0] }} </span>
              </div>
              <div
              ...
              >
                <font-awesome-icon
                  ...
                  class="opacity-60"
                />
                <span class=""> {{ marker.timestamp.split('T')[1] }} </span>
              </div>
              <div
...
export default {
  ...
  async created() {
    ...
    this.session.session_schedules.forEach((sessionSchedule) => {
      if (sessionSchedule.practice_group != null) {
