<template>
  <section class="flex flex-col items-center justify-center w-screen h-screen bg-white">
    <div class="flex flex-col items-center justify-center w-3/12 gap-6">
      ...
      <form method="post" @submit.prevent="register" class="flex flex-col w-full gap-4">
        <div class="flex flex-col w-full gap-1">
          ...
          <div class="relative group">
            <input
              ...
              type="email" placeholder="tu@madre.com" name="email" v-model="email">
          </div>
        </div>
        ...
        <div class="flex flex-col w-full gap-1">
          ...
          <div class="relative group">
            <input
              class="w-full px-4 py-2 text-sm font-semibold tracking-wide text-gray-600 bg-gray-100 border border-gray-100 rounded-lg outline-none transition-base group-hover:border-gray-200 focus:border-amber-500"
              :type="isShowPassword" placeholder="Ej. borjalachupa69" name="repeatPassword" v-model="repeatPassword">
            <font-awesome-icon icon="fa-solid fa-eye"
              class="absolute text-gray-600 -translate-y-1/2 cursor-pointer hover:text-black right-3 top-1/2 transition-base" @click="showPassword" />
          </div>
        </div>
